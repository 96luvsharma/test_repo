...
if nav == 'Efficient Frontier':
    ...
    X = st.selectbox('Markets', options=['Please select a market from this dropdown menu.','S&P500', 'DOW30','NASDAQ','DAX40' ],index=0)
    ...
    if btn:
        ...
        if 1 < len(X) < 40 :
            ...
            st.text("It may take 5-10 minutes depending on the market selected.")
            weight = []
            ...
            # Returns, Std, Weights, NewGraph = eff_front(newList,newWeights, graph=True)
